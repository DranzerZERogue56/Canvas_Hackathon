  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "repeat(7, 1fr)", gap: 8 }}>
      {days.map((d) => {
        ...
        return (
          <div key={iso} style={{ minHeight: 220, padding: 8, background: "white", borderRadius: 6, border: "1px solid #e5e7eb" }}>
            <div style={{ fontSize: 13, fontWeight: 600 }}>{d.toLocaleDateString(undefined, { weekday: "short", month: "short", day: "numeric" })}</div>
